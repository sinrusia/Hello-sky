...
package org.puremvc.as3.patterns.observer
{
	...
	public class Notification implements INotification
	{
		 ...
		 */
		public function Notification( name:String, body:Object=null, type:String=null, busyCursor:Boolean=false )
		{
			this.name = name;
			this.body = body;
			this.type = type;
		...
		/**
		 * get the setting of the <code>busyCursor</code>
		 * 
		 * @retury the busyCursor
		 */
		public function getBusyCursor():Boolean
		{
			return busyCursor;
		}
		...
		// the setting of the busyCursor
		private var busyCursor		:Boolean;
	}
}