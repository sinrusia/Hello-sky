 ...
 */
		...
		public function setScale(w : Number, h : Number) : void {
			if (_scale9Grid == null) {
				...
				var __w:Number = (_originalBitmap.width - _scale9Grid.width) / w;
				var __h:Number = (_originalBitmap.height - _scale9Grid.height) / h;
				
				w = Math.max(__w, _originalBitmap.width - _scale9Grid.width);
				h = Math.max(__h, _originalBitmap.height - _scale9Grid.height);
				resizeBitmap(w, h);
			}
		}
